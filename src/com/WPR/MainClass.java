 ...
 * [0505Finishedlist RM  class-nizing
 * []idx RM class-nizing
...
public class MainClass{
  public static void main(String[] args){    
    ...
    sql.createTable("placeTable(idx int, name varchar(32), product varchar(16), tellN varchar(16), dong varchar(8), goo varchar(8), address varchar(64), link varchar(64))");
    
    //extract IDX number from List(wrm) (firstPage, lastPage,  wrm)
    mArrayList = listIDXExtrator.extract(1,5,wrm); //first page to last page
    
    //<-----idx RM-----> IDX 컨텐츠 페이지 읽기
    int i=0;
    while(mArrayList.get(i)!=null){
